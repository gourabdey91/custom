		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Custom",
									"targetURL": "#customcustom-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"customcustom-display": {
								"semanticObject": "customcustom",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=custom.custom",
									"url": sap.ui.require.toUrl("custom/custom")
								}
							}
						}
					}
